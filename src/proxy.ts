...
function isAllowed(pathname: string, role: string) {
  if (role === "MANAGER") {
    return (
      ...
      pathname === "/dashboard/stock-adjustments" ||
      pathname.startsWith("/dashboard/stock-adjustments/") ||
      ...
      pathname === "/dashboard/pathao-delivery-report" ||
      pathname.startsWith("/dashboard/pathao-delivery-report/") ||
  ...
  if (role === "PACKAGING_AGENT") {
    return (
      ...
      pathname === "/dashboard/pathao-daily-report" ||
      pathname.startsWith("/dashboard/pathao-daily-report/") ||
      pathname === "/dashboard/stock-out-import" ||
      pathname.startsWith("/dashboard/stock-out-import/")
    );
  }
